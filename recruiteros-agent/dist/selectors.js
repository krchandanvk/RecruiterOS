...
exports.queryFallbackText = queryFallbackText;
exports.queryFallbackAttr = queryFallbackAttr;
/**
 ...
 */
async function queryFallbackText(page, selectors) {
 ...
 */
async function queryFallbackAttr(page, selectors, attrName) {
    for (const selector of selectors) {
        try {
            const locator = page.locator(selector).first();
            if (await locator.isVisible()) {
